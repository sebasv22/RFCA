 ...
 */
public class RandomForest_SQRT extends Bagging {
   ...
   */
  public RandomForest_SQRT() {

    RandomTree_SQRT rTree = new RandomTree_SQRT();
    ...
    public RandomForest_SQRT(int minNum) {

    RandomTree_SQRT rTree = new RandomTree_SQRT();
    rTree.setDoNotCheckCapabilities(true);
    rTree.setMinNum(minNum);
  ...
  public Capabilities getCapabilities() {
    ...
    // Cannot use the main RandomTree_SQRT object because capabilities checking has
    // been turned off
    // for that object.
    return (new RandomTree_SQRT()).getCapabilities();
  }
  ...
  protected String defaultClassifierString() {
    ...
    return "weka.classifiers.trees.RandomTree_SQRT";
  }
  ...
  /**
   * This method only accepts RandomTree_SQRT arguments.
   *
   * @param newClassifier the RandomTree_SQRT to use.
   * @exception if argument is not a RandomTree_SQRT
   */
  @Override
  @ProgrammaticProperty
  public void setClassifier(Classifier newClassifier) {
    if (!(newClassifier instanceof RandomTree_SQRT)) {
      throw new IllegalArgumentException(
        "RandomForest: Argument of setClassifier() must be a RandomTree_SQRT.");
    }
  ...
  public String numFeaturesTipText() {
    return ((RandomTree_SQRT) getClassifier()).KValueTipText();
  }
  ...
  public int getNumFeatures() {
    ...
    return ((RandomTree_SQRT) getClassifier()).getKValue();
  }
  ...
  public void setNumFeatures(int newNumFeatures) {
    ...
    ((RandomTree_SQRT) getClassifier()).setKValue(newNumFeatures);
  }
  ...
  public void setComputeAttributeImportance(boolean computeAttributeImportance) {
    ...
    ((RandomTree_SQRT)m_Classifier).setComputeImpurityDecreases(computeAttributeImportance);
  }
  ...
  public String maxDepthTipText() {
    return ((RandomTree_SQRT) getClassifier()).maxDepthTipText();
  }
  ...
  public int getMaxDepth() {
    return ((RandomTree_SQRT) getClassifier()).getMaxDepth();
  }
  ...
  public void setMaxDepth(int value) {
    ((RandomTree_SQRT) getClassifier()).setMaxDepth(value);
  }
  ...
  public String breakTiesRandomlyTipText() {
    return ((RandomTree_SQRT) getClassifier()).breakTiesRandomlyTipText();
  }
  ...
  public boolean getBreakTiesRandomly() {
    ...
    return ((RandomTree_SQRT) getClassifier()).getBreakTiesRandomly();
  }
  ...
  public void setBreakTiesRandomly(boolean newBreakTiesRandomly) {
    ...
    ((RandomTree_SQRT) getClassifier()).setBreakTiesRandomly(newBreakTiesRandomly);
  }
  ...
  public void setDebug(boolean debug) {
    ...
    ((RandomTree_SQRT) getClassifier()).setDebug(debug);
  }
  ...
  public void setNumDecimalPlaces(int num) {
    ...
    ((RandomTree_SQRT) getClassifier()).setNumDecimalPlaces(num);
  }
  ...
  public void setBatchSize(String size) {
    ...
    ((RandomTree_SQRT) getClassifier()).setBatchSize(size);
  }
  ...
  public void setSeed(int s) {
    ...
    super.setSeed(s);
    ((RandomTree_SQRT) getClassifier()).setSeed(s);
  }
  ...
  public double[] computeAverageImpurityDecreasePerAttribute(
    ...
    for (Classifier c : m_Classifiers) {
      double[][] forClassifier = ((RandomTree_SQRT) c).getImpurityDecreases();
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    RandomTree_SQRT classifier =
      ((RandomTree_SQRT) AbstractClassifier.forName(defaultClassifierString(),
        options));
  ...
  public static void main(String[] argv) {
    runClassifier(new RandomForest_SQRT(), argv);
  }
}
